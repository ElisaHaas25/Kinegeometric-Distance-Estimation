...
# returns the quantiles of the photogeometric distance posterior, like quantile_distpost3 and quantile_distpost4, additional input: magnitude phot_g_mean_mag, colour bp_rp, pseudocolour. Here, the R-functions are used.
